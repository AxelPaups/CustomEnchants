...
43 enchantements custom en français, répartis en 5 raretés, intégrés **nativement** à la table d'enchantement et à l'enclume grâce au registre Paper, avec panel admin et menu public.

## Fonctionnalités

- **43 enchantements** : 12 combat, 6 arcs, 3 trident, 10 outils, 10 armures, 2 divers — noms et descriptions en français.
...
|---|---|---|
| `/ce menu` | `customenchants.use` | Menu public en lecture seule |
